...
<head>
	...
	<script src="../js/incharge/foods.js"></script>
</head>
			...
			<div class="modal-content">
				...
				<form id="update">
					<div class="modal-body">
						...
						<input type="text" class="form-control" name="food_id" id="food_id" readonly>
						<label for="">Food Image</label>
