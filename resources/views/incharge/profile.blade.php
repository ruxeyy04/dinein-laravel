...
<head>
	...
	<script src="../js/incharge/profile.js"></script>
</head>
						...
						<div class="col-md-12">
							<div class="profile text-center mb-5" id="profile">
								...
								<form action="">
									...
									<input type="text" class="form-control text-center" id="view_userid" readonly>
			...
			<div class="modal-content">
				...
				<form id="update">
					<div class="modal-body">
						...
						<input type="hidden" class="form-control" name="usertype" value="Incharge" />
					</div>
